  ...
  return (
    <button onClick={() => setOpen((prev) => !prev)}>
      <svg width="66" height="60" viewBox="0 0 66 60">
        ...
        <rect x="0" y="0" width="56" height="50" rx="3" stroke="#375A6B" stroke-width="2"/>
        </svg>
{/*         <defs>
        <filter id="filter0_d_27_167" x="0" y="0" width="66" height="60" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
